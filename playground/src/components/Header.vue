...
async function copyLink() {
    ...
    const link = `${`${domain}`}?${playConfig.compLibShort}=${store.versions[playConfig.compLibShort]
...
<template>
    <nav class="header-nav" border-b-cyan-500 border-b shadow>
        ...
        <div flex items-center justify-around m-2>
            ...
            <a href="https://github.com/windi-ui/windi-ui" target="_blank" class="header-a">
                <Icon h-5 w-5 mx-2 dark-text-white o="gray" icon="mdi:github" />
            </a>
